...
TourScript.prototype.loadTour = function() {
    ...
    var beginFunc = function(event){
        ...
        this.dispatchEvent(new Event(TourScript.EVENT_TOUR_LOADED));
    };
    ...
    if(typeof scriptUrl == "object") {
        var orient = window.innerWidth > window.innerHeight ? TourScript.DEVICE_ORIENTATION_LANDSCAPE : TourScript.DEVICE_ORIENTATION_PORTRAIT;
    ...
    player.bindOnObject('rootPlayer', 'start', function(e){
        ...
        if(listenOrientationChanges) {
            rootPlayer.bind('orientationChange', function(){
                this.updateDeepLink();
                this.disposeTour();
                this.loadTour();
            }, this);
        ...
        rootPlayer.bind('tourEnded', function(){
            dispatchEvent(new Event(TourScript.EVENT_TOUR_ENDED));
        }, player, true);
    }, this, false);
